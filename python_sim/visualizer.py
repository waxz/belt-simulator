...
from config_parser import SimulatorConfig, Belt, Sensor
...
class Renderer:
    def __init__(self, config: SimulatorConfig, headless: bool = False, scale: float = 100.0):
        ...
        # Editor State
        self.playing = False
        self.selected_item = None # can be a Belt or Sensor
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if self.is_dragging and self.dragging_vertex_idx is not None and self.selected_item:
                    ...
                    self.editor_ui.show_props_for(self.selected_item)
    ...
    def render(self, physics_engine=None):
        ...
        if not self.headless:
            ...
            for i, txt in enumerate(texts):
                self.screen.blit(txt, (10, 10 + i * 30))
